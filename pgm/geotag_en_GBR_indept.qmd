---
title: "Geographical tags - The independent"
...
df<-readRDS("../corpus_raw/en_GBR_indept.RDS")
...
x$text<-str_replace(x$text,pattern = "Related Stories.*","")
x$text<-str_replace(x$text,pattern = "BIRTHDAYS\\..*","")
x$text<-str_replace(x$text,pattern = "Birthdays\\..*","")
# textes à supprimer
x$text<-str_replace_all(x$text,pattern = "Q\\&amp;A","")
x$text<-str_replace_all(x$text,pattern = "Q\\&A","")
x$text<-str_replace_all(x$text,pattern = "BREAKING ","")
x$text<-str_replace_all(x$text,pattern = "BREAKING: ","")
x$text<-str_replace_all(x$text,pattern = "Breaking: ","")
x$text<-str_replace_all(x$text,pattern = "Breaking - ","")
x$text<-str_replace_all(x$text,pattern = "Breaking news: ","")
x$text<-str_replace_all(x$text,pattern = "Editorial: ","")
x$text<-str_replace_all(x$text,pattern = "Video: ","")
x$text<-str_replace_all(x$text,pattern = "VIDEO: ","")
x$text<-str_replace_all(x$text,pattern = "Videos: ","")
x$text<-str_replace_all(x$text,pattern = "World news in brief. World ","")
x$text<-str_replace_all(x$text,pattern = "World news in brief. ","")
...
```{r}
td<-tidy(qd)
saveRDS(td,"../corpus_geo/en_GBR_indept_geo.RDS")
```
...
write.table(res,"../test/en_GBR_indept_geo_test.csv", row.names = F, sep=";")
```
